<template>
 <div class="bg-white rounded-[34px] p-4 h-[585px] w-[609px]">
            ...
            <div class="projectCont h-[397px] w-[553px] overflow-hidden rounded-[17px] bg-[#F9F9F9] flex items-center justify-center" @mouseover="playVideo" @mouseout="pauseVideo">
