<template>
 <div class="bg-white rounded-[34px] p-4 h-[585px] 2xl:w-[609px]">
            ...
            <div class="projectCont h-[397px] overflow-hidden rounded-[17px] bg-[#F9F9F9] hover:bg-white flex items-center justify-center" @mouseover="playVideo" @mouseout="pauseVideo">
