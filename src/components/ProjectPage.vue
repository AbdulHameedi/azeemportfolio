            ...
            <div class="max-w-[1536px] mx-auto">
                ...
                <div class="bg-white rounded-[35.54px] p-4 sm:p-[63px] mb-[32px]">
                    ...
                    <div class="flex gap-[23px] mb-[24px]">
                        <img class="w-[65%] rounded-[7px] md:rounded-[15px]" :src="frameOne" alt="frame_1">
                        <img class="w-[35%] rounded-[7px] md:rounded-[15px]" :src="frameTwo" alt="frame_2">
                    </div>
                    <div class="flex gap-5">
                        <img class="w-[40%] rounded-[7px] md:rounded-[15px]" :src="frameThree" alt="frame_3">
                        <img class="w-[60%] rounded-[7px] md:rounded-[15px]" :src="frameFour" alt="frame_4">
                    </div>
                </div>
                <!--  -->
