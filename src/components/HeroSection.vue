      ...
      <div class="2xl:flex flex-col items-center">    
        <div>
          ...
          <div class="relative" data-aos="fade-up" data-aos-duration="300" data-aos-offset="200" data-aos-easing="ease-in-out">
            <video ref="video" class="video w-full rounded-[15px] md:rounded-[40px]" src="https://res.cloudinary.com/doxshmcth/video/upload/v1721382186/abdulazeemportfolio/Ayomide_Akanji_Reel_zkn3ub.mp4" autoplay loop muted></video>
