        ...
        <div>
          ...
          <div class="relative" data-aos="fade-up" data-aos-duration="300" data-aos-offset="200" data-aos-easing="ease-in-out">
            ...
            <a href="https://res.cloudinary.com/doxshmcth/video/upload/v1721512722/abdulazeemportfolio/ayomide_reel_mkcsee.mp4">
              <svg class="absolute left-[24px] md:left-[55px] bottom-[23px] md:bottom-[43px] max-[768px]:w-[40px]" width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg">
